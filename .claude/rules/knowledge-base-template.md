...
| 2026-07-01 | Within-influencer residual-MAGNITUDE surprise SURVIVES (joint p .0016 rt / 1.4e-5 rp); preserves directional story (undisclosed +rt/−rp); γ₁ now identified. Signed residual flips signs (= different construct). Adopt residual-magnitude as the real construct | `surprise_within_influencer.do`. Still TODO before headline: re-run Holm+CV with residual measure; two-step (generated-regressor) bootstrap SEs; first-stage feature-set robustness |
